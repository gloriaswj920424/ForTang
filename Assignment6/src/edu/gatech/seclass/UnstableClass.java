...
public class UnstableClass {
    ...
    public static void unstableMethod1() {
        // NOT POSSIBLE: This method cannot be implemented because
        // suppose there exist such method that satisfy both conditions,
        // then by condition 1) there is a test suite that achieves 100%
        // path coverage that does not reveal the fault,
        // this implies that such test suite would also achieves 100%
        // branch coverage that does not reveal the fault,
        // which contradict with condition 2).
        // therefore such method is not possible) ***/
    }

    public static void unstableMethod2(int a , int b) {
        if (a > 0){
            System.out.println(1/(a-b));
        }
    }

    public static void unstableMethod3(int a, int b) {
        if (a > 0){
